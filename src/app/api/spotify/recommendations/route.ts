    ...
    if (!session || !session.accessToken) {
      return NextResponse.json({
        tracks: [
          ...
          { id: "rec_2", name: "Lofi Rain", artists: [{ name: "Rainy Vibe" }], album: { name: "Cozy Study", images: [{ url: "https://images.unsplash.com/photo-1487180142328-0c4e37023af5?w=150&auto=format&fit=crop&q=60" }] }, preview_url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3", external_urls: { spotify: "https://open.spotify.com" } },
