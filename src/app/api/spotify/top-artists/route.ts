    ...
    if (!session || !session.accessToken) {
      ...
      if (timeRange === "short_term") {
        ...
        items = [
          ...
          { id: "art_7", name: "Nujabes", genres: ["lofi", "hip-hop"], images: [{ url: "https://images.unsplash.com/photo-1518609878373-06d740f60d8b?w=150&auto=format&fit=crop&q=60" }], popularity: 65 }
        ];
      } else {
        items = [
          { id: "art_8", name: "The Weeknd", genres: ["pop", "r&b"], images: [{ url: "https://images.unsplash.com/photo-1506157786151-b8491531f063?w=150&auto=format&fit=crop&q=60" }], popularity: 94 },
          { id: "art_9", name: "Nirvana", genres: ["grunge", "rock"], images: [{ url: "https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=150&auto=format&fit=crop&q=60" }], popularity: 80 },
          { id: "art_10", name: "A.R. Rahman", genres: ["bollywood", "sufi", "tamil"], images: [{ url: "https://images.unsplash.com/photo-1498038432885-c6f3f1b912ee?w=150&auto=format&fit=crop&q=60" }], popularity: 78 }
        ];
      }
