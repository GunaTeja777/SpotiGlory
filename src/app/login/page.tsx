    ...
    switch (code) {
      ...
      case "OAuthCreateAccount":
        return {
          ...
          description: "Unable to complete Spotify OAuth handshake. Please verify that 'https://spoti-glory.vercel.app/api/auth/callback/spotify' is added under Redirect URIs in your Spotify Developer Dashboard, and your Spotify account email is added under Users and Access.",
        };
      case "Configuration":
        return {
